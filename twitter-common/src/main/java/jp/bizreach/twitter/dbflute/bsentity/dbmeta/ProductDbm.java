...
public class ProductDbm extends AbstractDBMeta {
    ...
    public class EpgProductStatusCode implements PropertyGateway {
        ...
        public void write(Entity e, Object v) {
            ...
            ccls(col, v);
            ((Product)e).setProductStatusCodeAsProductStatus((CDef.ProductStatus)gcls(col, v));
        }
    }
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, "商品ID", true, "productId", Integer.class, true, true, "INT", 10, 0, null, false, null, null, null, "purchaseList", null);
    ...
    protected final ColumnInfo _columnProductCategoryCode = cci("PRODUCT_CATEGORY_CODE", "PRODUCT_CATEGORY_CODE", null, "商品カテゴリコード", true, "productCategoryCode", String.class, false, false, "CHAR", 3, 0, null, false, null, null, "productCategory", null, null);
    protected final ColumnInfo _columnProductStatusCode = cci("PRODUCT_STATUS_CODE", "PRODUCT_STATUS_CODE", null, "商品ステータスコード", true, "productStatusCode", String.class, false, false, "CHAR", 3, 0, null, false, null, null, "productStatus", null, CDef.DefMeta.ProductStatus);
    protected final ColumnInfo _columnRegularPrice = cci("REGULAR_PRICE", "REGULAR_PRICE", null, "定価", true, "regularPrice", Integer.class, false, false, "INT", 10, 0, null, false, null, null, null, null, null);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.bizreach.twitter.dbflute.exentity.Product"; }
    public String getConditionBeanTypeName() { return "jp.bizreach.twitter.dbflute.cbean.ProductCB"; }
    public String getBehaviorTypeName() { return "jp.bizreach.twitter.dbflute.exbhv.ProductBhv"; }
