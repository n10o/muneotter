...
public class ProductCategoryDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.bizreach.twitter.dbflute.exentity.ProductCategory"; }
    public String getConditionBeanTypeName() { return "jp.bizreach.twitter.dbflute.cbean.ProductCategoryCB"; }
    public String getBehaviorTypeName() { return "jp.bizreach.twitter.dbflute.exbhv.ProductCategoryBhv"; }
