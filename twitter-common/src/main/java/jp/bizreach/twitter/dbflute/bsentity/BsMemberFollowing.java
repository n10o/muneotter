...
public abstract class BsMemberFollowing implements Entity, Serializable, Cloneable {
    ...
    /** (わたし)MY_MEMBER_ID: {IX, NotNull, INT(10), FK to member} */
    protected Integer _myMemberId;

    /** (あなた)YOUR_MEMBER_ID: {IX, NotNull, INT(10), FK to member} */
    ...
    /**
     * [get] (わたし)MY_MEMBER_ID: {IX, NotNull, INT(10), FK to member} <br />
    ...
    /**
     * [set] (わたし)MY_MEMBER_ID: {IX, NotNull, INT(10), FK to member} <br />
     * 気になった人がいて...勇気を振り絞った会員のID。
    ...
    /**
     * [get] (あなた)YOUR_MEMBER_ID: {IX, NotNull, INT(10), FK to member} <br />
    ...
    /**
     * [set] (あなた)YOUR_MEMBER_ID: {IX, NotNull, INT(10), FK to member} <br />
     * いきなりのアクションに...ちょっと心揺らいだ会員のID。
