    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberCQ> {
        ...
        public HpSDRFunction<MemberFollowingCB, MemberCQ> derivedMemberFollowingByMyMemberIdList() {
            ...
            return new HpSDRFunction<MemberFollowingCB, MemberCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<MemberFollowingCB, MemberCQ>() {
                public void setup(String function, SubQuery<MemberFollowingCB> subQuery, MemberCQ cq, String aliasName, DerivedReferrerOption option) {
                    cq.xsderiveMemberFollowingByMyMemberIdList(function, subQuery, aliasName, option); } }, _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer. <br />
         * {select max(FOO) from member_following where ...) as FOO_MAX} <br />
        ...
        public HpSDRFunction<MemberFollowingCB, MemberCQ> derivedMemberFollowingByYourMemberIdList() {
            ...
            return new HpSDRFunction<MemberFollowingCB, MemberCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<MemberFollowingCB, MemberCQ>() {
                public void setup(String function, SubQuery<MemberFollowingCB> subQuery, MemberCQ cq, String aliasName, DerivedReferrerOption option) {
                    cq.xsderiveMemberFollowingByYourMemberIdList(function, subQuery, aliasName, option); } }, _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)DerivedReferrer. <br />
         ...
         * <pre>
         * cb.specify().<span style="color: #FD4747">derivedTweetList()</span>.<span style="color: #FD4747">max</span>(new SubQuery&lt;TweetCB&gt;() {
         *     public void query(TweetCB subCB) {
         *         subCB.specify().<span style="color: #FD4747">columnFoo...</span> <span style="color: #3F7E5E">// derived column by function</span>
         *         subCB.query().setBar... <span style="color: #3F7E5E">// referrer condition</span>
         *     }
         * }, Tweet.<span style="color: #FD4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<TweetCB, MemberCQ> derivedTweetList() {
            ...
            return new HpSDRFunction<TweetCB, MemberCQ>(_baseCB, _qyCall.qy(), new HpSDRSetupper<TweetCB, MemberCQ>() {
                public void setup(String function, SubQuery<TweetCB> subQuery, MemberCQ cq, String aliasName, DerivedReferrerOption option) {
                    cq.xsderiveTweetList(function, subQuery, aliasName, option); } }, _dbmetaProvider);
        }
        /**
