...
public class MemberSecurityDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, "会員ID", true, "memberId", Integer.class, true, false, "INT", 10, 0, null, false, null, null, "member", null, null);
    ...
    protected final ColumnInfo _columnReminderUseCount = cci("REMINDER_USE_COUNT", "REMINDER_USE_COUNT", null, "リマインダ利用回数", true, "reminderUseCount", Integer.class, false, false, "INT", 10, 0, null, false, null, null, null, null, null);
