...
public class MemberDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, "会員ID", true, "memberId", Integer.class, true, true, "INT", 10, 0, null, false, null, null, "memberAddressAsValid,memberLoginAsLatest,memberSecurityAsOne,memberServiceAsOne,memberWithdrawalAsOne", "memberAddressList,memberFollowingByMyMemberIdList,memberFollowingByYourMemberIdList,memberLoginList,purchaseList,tweetList", null);
    ...
    protected final ColumnInfo _columnFormalizedDatetime = cci("FORMALIZED_DATETIME", "FORMALIZED_DATETIME", null, "正式会員日時", false, "formalizedDatetime", java.sql.Timestamp.class, false, false, "DATETIME", 19, 0, null, false, null, null, null, null, null);
    ...
    public ForeignInfo foreignMemberSecurityAsOne() {
        ...
        return cfi("FK_MEMBER_SECURITY_MEMBER", "memberSecurityAsOne", this, MemberSecurityDbm.getInstance(), map, 3, true, false, true, false, null, null, false, "member");
    }
    public ForeignInfo foreignMemberServiceAsOne() {
        ...
        return cfi("FK_MEMBER_SERVICE_MEMBER", "memberServiceAsOne", this, MemberServiceDbm.getInstance(), map, 4, true, false, true, false, null, null, false, "member");
    }
    public ForeignInfo foreignMemberWithdrawalAsOne() {
        ...
        return cfi("FK_MEMBER_WITHDRAWAL_MEMBER", "memberWithdrawalAsOne", this, MemberWithdrawalDbm.getInstance(), map, 5, true, false, true, false, null, null, false, "member");
    }
    ...
    public ReferrerInfo referrerMemberFollowingByMyMemberIdList() {
        ...
        return cri("FK_MEMBER_FLLOWING_MY_MEMBER_ID", "memberFollowingByMyMemberIdList", this, MemberFollowingDbm.getInstance(), map, false, "memberByMyMemberId");
    }
    public ReferrerInfo referrerMemberFollowingByYourMemberIdList() {
        ...
        return cri("FK_MEMBER_FOLLOWING_YOUR_MEMBER_ID", "memberFollowingByYourMemberIdList", this, MemberFollowingDbm.getInstance(), map, false, "memberByYourMemberId");
    }
