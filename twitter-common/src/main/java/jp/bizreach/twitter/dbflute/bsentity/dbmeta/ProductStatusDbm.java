...
public class ProductStatusDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "jp.bizreach.twitter.dbflute.exentity.ProductStatus"; }
    public String getConditionBeanTypeName() { return "jp.bizreach.twitter.dbflute.cbean.ProductStatusCB"; }
    public String getBehaviorTypeName() { return "jp.bizreach.twitter.dbflute.exbhv.ProductStatusBhv"; }
