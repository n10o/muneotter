...
public class BsTweetCQ extends AbstractBsTweetCQ {
    ...
    protected ConditionValue _tweetContents;
    public ConditionValue getTweetContents() {
        if (_tweetContents == null) { _tweetContents = nCV(); }
        return _tweetContents;
    }
    protected ConditionValue getCValueTweetContents() { return getTweetContents(); }
     ...
     * @return this. (NotNull)
     */
    public BsTweetCQ addOrderBy_TweetContents_Asc() { regOBA("TWEET_CONTENTS"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTweetCQ addOrderBy_TweetContents_Desc() { regOBD("TWEET_CONTENTS"); return this; }
    ...
    public ConditionValue getDatetime() {
        if (_datetime == null) { _datetime = nCV(); }
        return _datetime;
    }
    protected ConditionValue getCValueDatetime() { return getDatetime(); }
     ...
     * @return this. (NotNull)
     */
    public BsTweetCQ addOrderBy_Datetime_Asc() { regOBA("DATETIME"); return this; }
     ...
     * @return this. (NotNull)
     */
    public BsTweetCQ addOrderBy_Datetime_Desc() { regOBD("DATETIME"); return this; }
