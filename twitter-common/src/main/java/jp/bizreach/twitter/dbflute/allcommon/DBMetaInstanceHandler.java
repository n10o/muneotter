...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("member_address", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("member_following", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.MemberFollowingDbm");
        tmpMap.put("member_login", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("member_security", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("member_service", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("member_status", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("member_withdrawal", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("product", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("product_category", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("product_status", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("purchase", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("region", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.RegionDbm");
        tmpMap.put("service_rank", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("tweet", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.TweetDbm");
        tmpMap.put("withdrawal_reason", "jp.bizreach.twitter.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
